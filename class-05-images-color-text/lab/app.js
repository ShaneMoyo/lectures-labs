...
return [sumABC, productABC,
     a + ' and ' + b + ' and ' + c + ' sum to ' + sumABC + '.',
...
var productArray = multiply(arrayProduct1, testArray[2])[0]
return [productArray,'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + 
' have a product of '
+ productArray + '.']
